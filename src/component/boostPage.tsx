...
const BoostPage: React.FC = () => {
  ...
  const endpoint= process.env.REACT_APP_SOLANA_END_POINT || "";
        ...
        <WalletModalProvider>
          <div className="flex flex-col items-center justify-center text-center">  
              ...
              <div className="flex flex-col justify-between w-[300px]">
                <div className="text-xl text-goldenYellow">
                  F$: {NumberWithCommas(fCount)/*toFixed(2)*/}
                </div>

                <div className="text-center">                  
                  <div className="flex justify-center mt-8">
                    <button
                      className={` text-white px-8 py-3 rounded text-xl ${ fCount<myConstants.F$_boost ? 'bg-gray-600 cursor-not-allowed':'bg-green-700'}`}
