...
const SolanaConnection = () => {
    ...
    const recieverAddress = process.env.REACT_APP_RECIEVER_ADDRESS || ""; 
    ...
    const SHAMY_TOKEN_MINT_ADDRESS =process.env.REACT_APP_SHAMY_TOKEN_MINT_ADDRESS || "";
    const USDT_TOKEN_MINT_ADDRESS =  process.env.REACT_APP_USDT_TOKEN_MINT_ADDRESS || ""; 
