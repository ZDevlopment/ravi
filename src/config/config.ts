...
export const myConstants = {
  Max_Level: parseInt(process.env.REACT_APP_MAX_LEVEL || '0',10),
  F$rate: parseInt(process.env.REACT_APP_FRATE || '0',10),
  miner_base_cost: parseInt(process.env.REACT_APP_MINER_BASE_COST || '0',10), // Level 1 miner cost
  level_up_base_multiplier: 5, // Level upgrade multiplier
  Growth_rate_per_level: parseInt(process.env.REACT_APP_GROWTH_PER_LEVEL|| '0',10), //  growth from the previous level
  F$_Multiplier: parseInt(process.env.REACT_APP_FMULTIPLIER|| '0',10), // x5 boost multiplier
  $Shamy_Multiplier: parseInt(process.env.REACT_APP_SHAMY_MULTIPLIER|| '0',10), // x15 boost multiplier for shamy tokens
  F$_boost:parseInt(process.env.REACT_APP_FBOOST || '0',10), // boost value for F$
  ShamyBoost:parseInt(process.env.REACT_APP_SHAMY_BOOST || '0',10), // No of Tokens needed for shamy boost
  Additional_entryCost: parseInt(process.env.REACT_APP_ADD_ENTRY || '0',10),
  Referral_Sign_Bonus: parseInt(process.env.REACT_APP_REF_SIGNUP_BONUS || '0',10),
  Referral_Subscribe_Bonus:parseInt(process.env.REACT_APP_REF_SUB_BONUS || '0',10), // when a refered user buys a subscription, only valid for once 
